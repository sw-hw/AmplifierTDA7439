...
static void TDA7439_DisplayInit(void)
{
	...
	ILI9488_LedEnable();
	// ===
	ILI9488_Draw_Text("Headphone:",		30,  10, ILI9488_BLUE, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
	ILI9488_Draw_Text("Power amp:",		30,  30, ILI9488_BLUE, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
	ILI9488_Draw_Text("Multiplexer:",	30,  50, ILI9488_BLUE, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
	ILI9488_Draw_Text("Input gain:",	30,  70, ILI9488_BLUE, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
	// ---
	ILI9488_Draw_Text("Volume:",		300, 10, ILI9488_BLUE, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
	ILI9488_Draw_Text("Bass:",			300, 30, ILI9488_BLUE, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
	ILI9488_Draw_Text("Mid:",			300, 50, ILI9488_BLUE, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
	ILI9488_Draw_Text("Treble:",		300, 70, ILI9488_BLUE, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
}
...
static void TDA7439_DisplayRedrawSelector(void)
{
	...
	{
		case TDA7439_MARKER_HEAD:
			ILI9488_Draw_Char(' ', 280, 70, ILI9488_ORANGE, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
			ILI9488_Draw_Char('>', 10, 10, ILI9488_ORANGE, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
			break;
		case TDA7439_MARKER_POW_AMP:
			ILI9488_Draw_Char(' ', 10, 10, ILI9488_ORANGE, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
			ILI9488_Draw_Char('>', 10, 30, ILI9488_ORANGE, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
			break;
		case TDA7439_MARKER_MULTIPLEXER:
			ILI9488_Draw_Char(' ', 10, 30, ILI9488_ORANGE, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
			ILI9488_Draw_Char('>', 10, 50, ILI9488_ORANGE, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
			break;
		case TDA7439_MARKER_GAIN:
			ILI9488_Draw_Char(' ', 10, 50, ILI9488_ORANGE, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
			ILI9488_Draw_Char('>', 10, 70, ILI9488_ORANGE, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
			break;
		case TDA7439_MARKER_VOLUME:
			ILI9488_Draw_Char(' ', 10, 70, ILI9488_ORANGE, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
			ILI9488_Draw_Char('>', 280, 10, ILI9488_ORANGE, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
			break;
		case TDA7439_MARKER_BASS:
			ILI9488_Draw_Char(' ', 280, 10, ILI9488_ORANGE, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
			ILI9488_Draw_Char('>', 280, 30, ILI9488_ORANGE, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
			break;
		case TDA7439_MARKER_MID:
			ILI9488_Draw_Char(' ', 280, 30, ILI9488_ORANGE, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
			ILI9488_Draw_Char('>', 280, 50, ILI9488_ORANGE, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
			break;
		case TDA7439_MARKER_TREBLE:
			ILI9488_Draw_Char(' ', 280, 50, ILI9488_ORANGE, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
			ILI9488_Draw_Char('>', 280, 70, ILI9488_ORANGE, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
...
{
	// TODO
	ILI9488_Draw_Text("ON",		140, 10, ILI9488_RED, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
	ILI9488_Draw_Text("OFF",	140, 30, ILI9488_RED, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
	ILI9488_Draw_Text("1 ch",	140, 50, ILI9488_RED, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
	ILI9488_Draw_Text("0 dB",	140, 70, ILI9488_RED, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
	// ---
	ILI9488_Draw_Text("0 dB",	373, 10, ILI9488_RED, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
	ILI9488_Draw_Text("0 dB",	373, 30, ILI9488_RED, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
	ILI9488_Draw_Text("0 dB",	373, 50, ILI9488_RED, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
	ILI9488_Draw_Text("0 dB",	373, 70, ILI9488_RED, 1, TDA7439_DISPLAY_COLOR_BACKGROUND);
}
